...
public class TacoSpigotWorldConfig {
	...
	private void isArmorStandMoveWithoutGravity() {
		optimizeArmorStandMovement = getBoolean("armor-stand.optimize-movement", false); // Doesn't fully emulate
																							// vanilla behavior, see
																							// issue #1
	}
	...
	private void isOptimizeLiquidExplosions() {
		optimizeLiquidExplosions = getBoolean("tnt.optimize-liquid-explosions", true); // This seems like a pretty sane
																						// default
	}
