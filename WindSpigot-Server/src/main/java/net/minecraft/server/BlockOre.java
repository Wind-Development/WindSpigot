...
public class BlockOre extends Block {
	...
	public void dropNaturally(World world, BlockPosition blockposition, IBlockData iblockdata, float f, int i) {
		 ...
		 * world.random, i) != Item.getItemOf(this)) { int j = 0;
		 * 
		 * if (this == Blocks.COAL_ORE) { j = MathHelper.nextInt(world.random, 0, 2); }
		 * else if (this == Blocks.DIAMOND_ORE) { j = MathHelper.nextInt(world.random,
		 * 3, 7); } else if (this == Blocks.EMERALD_ORE) { j =
		 * MathHelper.nextInt(world.random, 3, 7); } else if (this == Blocks.LAPIS_ORE)
		 * { j = MathHelper.nextInt(world.random, 2, 5); } else if (this ==
		 * Blocks.QUARTZ_ORE) { j = MathHelper.nextInt(world.random, 2, 5); }
		 * 
