...
public interface IWorldAccess {
	...
	void a(int var1, boolean var2, double var3, double var5, double var7, double var9, double var11, double var13,
			int... var15);
	...
	void sendPlayWorldPacket(EntityHuman var1, int var2, int blockPosition_x, int blockPosition_y, int blockPosition_z,
			int var4);
