...
public class EntityDamageSourceIndirect extends EntityDamageSource
{
	...
	public IChatBaseComponent getLocalizedDeathMessage(EntityLiving entityliving)
	{
		...
		return itemstack != null && itemstack.hasName() && LocaleI18n.c(s1) ? new ChatMessage(s1, new Object[]
		{ entityliving.getScoreboardDisplayName(), ichatbasecomponent, itemstack.C() })
				: new ChatMessage(s, new Object[]
				{ entityliving.getScoreboardDisplayName(), ichatbasecomponent });
	}
