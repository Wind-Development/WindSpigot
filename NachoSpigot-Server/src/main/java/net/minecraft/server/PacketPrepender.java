...
public class PacketPrepender extends MessageToMessageEncoder<ByteBuf> {
	...
	/*
	 * protected void a(ChannelHandlerContext ctx, ByteBuf in, ByteBuf out) throws
	 * Exception { int var4 = in.readableBytes(); int var5 =
	 * PacketDataSerializer.a(var4); if (var5 > 3) { throw new
	 * IllegalArgumentException("unable to fit " + var4 + " into " + 3); } else {
	 * PacketDataSerializer var6 = new PacketDataSerializer(out);
	 * var6.ensureWritable(var5 + var4); var6.b(var4); var6.writeBytes(in,
	 * in.readerIndex(), var4); } }
	 * 
	 */
}