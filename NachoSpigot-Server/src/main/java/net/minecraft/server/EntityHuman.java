...
public abstract class EntityHuman extends EntityLiving
{
	...
	public void m()
	{
		...
		if (this.getHealth() > 0.0F && !this.isSpectator())
		{
			...
			if (this.ae())
			{ // Spigot: Add this.ae() condition (second !this.isDead near bottom of
				// EntityLiving)
	...
	public boolean damageEntity(DamageSource damagesource, float f)
	{
		...
		} else
		{
			...
			} else
			{
				...
				if (false && f == 0.0F)
				{ // CraftBukkit - Don't filter out 0 damage
					return false;
				} else
				{
