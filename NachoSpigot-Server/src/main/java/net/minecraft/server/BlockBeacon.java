...
public class BlockBeacon extends BlockContainer {
	...
	@Override
	public boolean interact(World var1, BlockPosition var2, IBlockData var3, EntityHuman var4, EnumDirection var5,
	...
	public static void f(final World var0, final BlockPosition blockPos) {
		/*
		 * HttpUtilities.a.submit(new Runnable() { public void run() {
		 */ // Paper
		...
		for (int blockY = blockPos.getY() - 1; blockY >= 0; --blockY) {
			...
			if (var4.getBlock() == Blocks.BEACON) {
				...
				/*
				 * ((WorldServer)var0).postToMainThread(new Runnable() { public void run() {
				 */ // Paper
