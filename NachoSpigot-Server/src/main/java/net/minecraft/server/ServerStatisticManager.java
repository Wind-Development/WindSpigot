...
public class ServerStatisticManager extends StatisticManager
{
	...
	public void setStatistic(EntityHuman entityhuman, Statistic statistic, int i)
	{
		...
		if (statistic.d() && j == 0 && i > 0)
		{
			...
			if (this.c.aB())
			{
				this.c.getPlayerList().sendMessage(new ChatMessage("chat.type.achievement", new Object[]
		...
		if (statistic.d() && j > 0 && i == 0)
		{
			...
			if (this.c.aB())
			{
				this.c.getPlayerList().sendMessage(new ChatMessage("chat.type.achievement.taken", new Object[]
				{ entityhuman.getScoreboardDisplayName(), statistic.j() }));
			}
		}
