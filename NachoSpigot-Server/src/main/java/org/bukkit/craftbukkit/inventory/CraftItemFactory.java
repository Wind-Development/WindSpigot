...
public final class CraftItemFactory implements ItemFactory {
	...
	static {
		...
		KNOWN_NBT_ATTRIBUTE_NAMES = ImmutableSet.<String>builder().add("generic.attackDamage")
				.add("generic.followRange").add("generic.knockbackResistance").add("generic.maxHealth")
	...
	boolean equals(CraftMetaItem meta1, CraftMetaItem meta2) {
		 ...
		 * purposes and letting each method perform its own function.
		 *
		 * The common and uncommon were split, as both could have variables not
		 * applicable to the other, like a skull and book. Each object needs its chance
		 * to say "hey wait a minute, we're not equal," but without the redundancy of
		 * using the 1.equals(2) && 2.equals(1) checking the 'commons' twice.
		 *
