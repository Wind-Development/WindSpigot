...
public interface Block extends Metadatable {
	 ...
	 * <p>
	 * Any light given from other sources (such as blocks like torches) will be
	 * ignored.
	 *
	...
	/**
	 * Captures the current state of this block. You may then cast that state into
	 * any accepted type, such as Furnace or Sign.
	 * <p>
	 ...
	 *
	 * @param face the face of the block to query or BlockFace.SELF for the block
	 *             itself
	...
	/**
	 * Returns a list of items which would drop by destroying this block with a
	 * specific tool
	 *
	 * @param tool The tool or item in hand used for digging
	 * @return a list of dropped items for this type of block
