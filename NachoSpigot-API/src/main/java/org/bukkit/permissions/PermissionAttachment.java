...
public class PermissionAttachment {
	...
	/**
	 * Gets the class that was previously set to be called when this attachment was
	 * removed from a {@link Permissible}. May be null.
	 *
	 ...
	 *
	 * @return true if the permissible was removed successfully, false if it did not
	 *         exist
	 */
