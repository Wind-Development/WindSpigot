...
public interface PotionMeta extends ItemMeta {
	...
	/**
	 * Gets an immutable list containing all custom potion effects applied to this
	 * potion.
	 * <p>
	 * Plugins should check that hasCustomEffects() returns true before calling this
	 * method.
	 *
