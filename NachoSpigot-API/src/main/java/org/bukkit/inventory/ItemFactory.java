...
public interface ItemFactory {
	...
	/**
	 * This method checks the item meta to confirm that it is applicable (no data
	 * lost if applied) to the specified ItemStack.
	 * <p>
	 * A {@link SkullMeta} would not be valid for a sword, but a normal
	 * {@link ItemMeta} from an enchanted dirt block would.
	 *
	...
	/**
	 * This method checks the item meta to confirm that it is applicable (no data
	 * lost if applied) to the specified Material.
	 * <p>
	 * A {@link SkullMeta} would not be valid for a sword, but a normal
	 * {@link ItemMeta} from an enchanted dirt block would.
	 *
	 ...
	 * <p>
	 * The item meta returned will always be a valid meta for a given ItemStack of
	 * the specified material. It may be a more or less specific meta, and could
	 * also be the same meta or meta type as the parameter. The item meta returned
	 * will also always be the most appropriate meta.
	 * <p>
	 * Example, if a {@link SkullMeta} is being applied to a book, this method would
	 * return a {@link BookMeta} containing all information in the specified meta
	 * that is applicable to an {@link ItemMeta}, the highest common interface.
	 *
	 * @param meta  the meta to convert
	 * @param stack the stack to convert the meta for
	 * @return An appropriate item meta for the specified item stack. No guarantees
	 *         are made as to if a copy is returned. This will be null for a stack
	 *         of air.
	 * @throws IllegalArgumentException if the specified meta was not created by
	 *                                  this factory
	 */
