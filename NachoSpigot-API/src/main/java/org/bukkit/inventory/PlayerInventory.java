...
public interface PlayerInventory extends Inventory {
	 ...
	 * <p>
	 * Indexes 0 through 8 refer to the hotbar. 9 through 35 refer to the main
	 * inventory, counting up from 9 at the top left corner of the inventory, moving
	 * to the right, and moving to the row below it back on the left side when it
	 * reaches the end of the row. It follows the same path in the inventory like
	 * you would read a book.
	 * <p>
	 * Indexes 36 through 39 refer to the armor slots. Though you can set armor with
	 * this method using these indexes, you are encouraged to use the provided
	 * methods for those slots.
	 * <p>
	 * If you attempt to use this method with an index less than 0 or greater than
	 * 39, an ArrayIndexOutOfBounds exception will be thrown.
	 *
	...
	/**
	 * Put the given ItemStack into the chestplate slot. This does not check if the
	 * ItemStack is a chestplate
	 *
	...
	/**
	 * Clears all matching items from the inventory. Setting either value to -1 will
	 * skip it's check, while setting both to -1 will clear all items in your
