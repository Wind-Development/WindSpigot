...
/**
 * A single entry from a ban list. This may represent either a player ban or an
 * IP ban.
 * <p>
 ...
 * </table>
 * <p>
 * Unsaved information is not automatically written to the implementation's ban
 * list, instead, the {@link #save()} method must be called to write the changes
 * to the ban list. If this ban entry has expired (such as from an unban) and is
 * no longer found in the list, the {@link #save()} call will re-add it to the
 * list, therefore banning the victim specified.
 * <p>
...
public interface BanEntry {
	 ...
	 * <p>
	 * Note: A source is considered any String, although this is generally a player
	 * name.
	 *
	...
	/**
	 * Sets the date this ban expires on. Null values are considered "infinite"
	 * bans.
	 *
	 ...
	 * <p>
	 * Saving the ban entry of an unbanned player will cause the player to be banned
	 * once again.
	 */
	public void save();
}
