...
public interface MapCanvas {
	...
	/**
	 * Set the cursor collection associated with this canvas. This does not usually
	 * need to be called since a MapCursorCollection is already provided.
	 *
	 ...
	 * move down one line and return to the original column, and the text color can
	 * be changed using sequences such as "§12;", replacing 12 with the palette
	 * index of the color (see {@link MapPalette}).
	 *
