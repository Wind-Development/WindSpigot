...
public interface ServicesManager {
	...
	/**
	 * Returns whether a provider has been registered for a service. Do not check
	 * this first only to call <code>load(service)</code> later, as that would be a
	 * non-thread safe situation.
	 *
	 * @param <T>     service
