...
public class TimedRegisteredListener extends RegisteredListener {
	...
	/**
	 * Gets the class of the events this listener handled. If it handled multiple
	 * classes of event, the closest shared superclass will be returned, such that
	 * for any event this listener has handled,
	 * <code>this.getEventClass().isAssignableFrom(event.getClass())</code> and no
	 * class <code>this.getEventClass().isAssignableFrom(clazz)
	...
	/**
	 * Gets whether this listener has handled multiple events, such that for some
	 * two events, <code>eventA.getClass() != eventB.getClass()</code>.
	 *
