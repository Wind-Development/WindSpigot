...
public enum DyeColor {
	 ...
	 * @deprecated The name is misleading. It would imply {@link Material#INK_SACK}
	 *             but uses {@link Material#WOOL}
	 * @see #getWoolData()
	 * @see #getDyeData()
	 */
	@Deprecated
	 ...
	 * @return The {@link DyeColor} representing the given value, or null if it
	 *         doesn't exist
	 * @deprecated The name is misleading. It would imply {@link Material#INK_SACK}
	 *             but uses {@link Material#WOOL}
