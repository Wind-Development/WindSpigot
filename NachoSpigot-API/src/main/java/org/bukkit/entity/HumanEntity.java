...
public interface HumanEntity extends LivingEntity, AnimalTamer, Permissible, InventoryHolder {
	...
	/**
	 * Opens an inventory window with the specified inventory on the top and the
	 * player's inventory on the bottom.
	 *
	...
	/**
	 * Opens an empty workbench inventory window with the player's inventory on the
	 * bottom.
	 *
	 * @param location The location to attach it to. If null, the player's location
	 *                 is used.
	 * @param force    If false, and there is no workbench block at the location, no
	...
	/**
	 * Opens an empty enchanting inventory window with the player's inventory on the
	 * bottom.
	 *
	 * @param location The location to attach it to. If null, the player's location
	 *                 is used.
	 * @param force    If false, and there is no enchanting table at the location,
	...
	/**
	 * Sets the item to the given ItemStack, this will replace whatever the user was
	 * holding.
	 *
	...
	/**
	 * Returns the ItemStack currently on your cursor, can be empty. Will always be
	 * empty if the player currently has no open window.
	 *
	...
	/**
	 * Sets the item to the given ItemStack, this will replace whatever the user was
	 * moving. Will always be empty if the player currently has no open window.
	 *
	 * @param item The ItemStack which will end up in the hand
	 */
