...
public interface Hanging extends Entity, Attachable {
	...
	/**
	 * Sets the direction of the hanging entity, potentially overriding rules of
	 * placement. Note that if the result is not valid the object would normally
	 * drop as an item.
	 *
	 ...
	 *         in order to face the given direction.
	 */
