 ...
 * Note:
 * <ul>
 * <li>The Block returned by getBlock() is the block we are trying to place on,
 * not the block we are trying to place.
 * <li>If you want to figure out what is being placed, use
 * {@link #getMaterial()} or {@link #getMaterialId()} instead.
 * </ul>
 */
public class BlockCanBuildEvent extends BlockEvent {
	 ...
	 * <p>
	 * By default, returns Minecraft's answer on whether the block can be built here
	 * or not.
	 *
	 ...
	 *
	 * @param cancel true if you want to allow the block to be built here despite
	 *               Minecraft's default behaviour
	 */
