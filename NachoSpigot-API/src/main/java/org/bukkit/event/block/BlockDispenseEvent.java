...
public class BlockDispenseEvent extends BlockEvent implements Cancellable {
	...
	/**
	 * Gets the item that is being dispensed. Modifying the returned item will have
	 ...
	 * Gets the velocity.
	 * <p>
	 * Note: Modifying the returned Vector will not change the velocity, you must
	 * use {@link #setVelocity(org.bukkit.util.Vector)} instead.
	 *
