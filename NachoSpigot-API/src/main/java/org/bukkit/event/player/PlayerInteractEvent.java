...
public class PlayerInteractEvent extends PlayerEvent implements Cancellable {
	 ...
	 * <p>
	 * Canceling this event will prevent use of food (player won't lose the food
	 * item), prevent bows/snowballs/eggs from firing, etc. (player won't lose the
	 * ammo)
	 *
	 ...
	 * This event gets processed for all blocks, but most don't have a default
	 * action
	 *
