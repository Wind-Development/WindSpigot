...
public class PlayerEditBookEvent extends PlayerEvent implements Cancellable {
	...
	public PlayerEditBookEvent(Player who, int slot, BookMeta previousBookMeta, BookMeta newBookMeta,
			boolean isSigning) {
		super(who);
	 ...
	 * <p>
	 * Note: this is a copy of the book meta. You cannot use this object to change
	 * the existing book meta.
	 *
	 ...
	 * {@link #setNewBookMeta(BookMeta)} to change what will actually be added to
	 * the book.
	 *
