 ...
 * <code>@a</code> and <code>@p</code> decorators used by Command Blocks for
 * plugins that do not handle it.
 ...
 * command <code>/calias cr gamemode creative</code>, the next time they run
