...
public class EntityDamageEvent extends EntityEvent implements Cancellable {
	 ...
	 * @see #getFinalDamage()
	 * @throws IllegalArgumentException      if type is null
	 * @throws UnsupportedOperationException if the caller does not support the
	 *                                       particular DamageModifier, or to
	 *                                       rephrase, when
	 *                                       {@link #isApplicable(DamageModifier)}
	 *                                       returns false
	 */
	...
	/**
	 * This checks to see if a particular modifier is valid for this event's caller,
	 * such that, {@link #setDamage(DamageModifier, double)} will not throw an
	...
	/**
	 * Gets the amount of damage caused by the event after all damage reduction is
	 * applied.
	 *
	 ...
	 * <p>
	 * For compatibility this also recalculates the modifiers and scales them by the
	 * difference between the modifier for the previous damage value and the new
	 * one.
	 *
	 * @param damage The raw amount of damage caused by the event
	 */
	public void setDamage(double damage) {
		// These have to happen in the same order as the server calculates them, keep
		// the enum sorted
	...
	public enum DamageModifier {
		/**
		 * This represents the amount of damage being done, also known as the raw
		 * {@link EntityDamageEvent#getDamage()}.
		 */
		BASE,
		/**
		 * This represents the damage reduced by a wearing a helmet when hit by a
		 * falling block.
		 */
		HARD_HAT,
		/**
		 ...
		 * <ul>
		 * <li>Armor enchantments</li>
		 * <li>Witch's potion resistance</li>
		 * </ul>
		 */
		MAGIC,
		/**
