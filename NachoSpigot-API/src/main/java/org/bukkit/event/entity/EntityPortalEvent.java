...
/**
 * Called when a non-player entity is about to teleport because it is in contact
 * with a portal.
 * <p>
...
public class EntityPortalEvent extends EntityTeleportEvent {
	 ...
	 * {@link #getTo()} Location, and will try to create one if there is none.
	 * <p>
	 * If this is set to false, the {@link #getEntity()} will only be teleported to
	 * the {@link #getTo()} Location.
	 *
