...
public enum InventoryAction {
	...
	PLACE_ALL,
	/**
	 * Some of the items from the cursor are moved to the clicked slot (usually up
	...
	CLONE_STACK,
	/**
	 * The inventory is searched for the same material, and they are put on the
	 * cursor up to {@link org.bukkit.Material#getMaxStackSize()}.
	 */
	COLLECT_TO_CURSOR,
	/**
