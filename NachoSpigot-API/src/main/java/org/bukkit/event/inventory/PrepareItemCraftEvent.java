...
public class PrepareItemCraftEvent extends InventoryEvent {
	...
	/**
	 * Get the recipe that has been formed. If this event was triggered by a tool
	 * repair, this will be a temporary shapeless recipe representing the repair.
	 *
	...
	/**
	 * Check if this event was triggered by a tool repair operation rather than a
	 * crafting recipe.
	 *
