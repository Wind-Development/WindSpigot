 ...
 * using {@link BukkitScheduler#runTask(Plugin, Runnable)}, which would execute
 * the task on the next tick, would work as well.
 */
public class InventoryDragEvent extends InventoryInteractEvent {
	 ...
	 *
	 * @return list of converted slot ids, suitable for
	 ...
	 * <p>
	 * Changing this item stack changes the cursor item. Note that changing the
	 * affected "dragged" slots does not change this ItemStack, nor does changing
	 * this ItemStack affect the "dragged" slots.
	 *
	...
	/**
	 * Gets an ItemStack representing the cursor prior to any modifications as a
	 * result of this drag.
	 *
	...
	/**
	 * Gets the DragType that describes the behavior of ItemStacks placed after this
	 * InventoryDragEvent.
	 * <p>
	 * The ItemStacks and the raw slots that they're being applied to can be found
	 * using {@link #getNewItems()}.
	 *
