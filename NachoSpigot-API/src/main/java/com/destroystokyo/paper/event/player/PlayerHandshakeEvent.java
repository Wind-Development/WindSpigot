 ...
 *
 * <p>
 * If there are no listeners listening to this event, the logic default to your
 * server platform will be ran.
 * </p>
 *
 * <p>
...
public class PlayerHandshakeEvent extends Event implements Cancellable {
	 ...
	 * </p>
	 *
	 * @param cancelled {@code true} if this event is cancelled, {@code false}
	 *                  otherwise
	 */
	@Override
	 ...
	 *
	 * <p>
	 * When {@code true}, the client connecting will be disconnected with the
	 * {@link #getFailMessage() fail message}.
	 * </p>
	 *
