...
/**
 * Extended version of {@link ServerListPingEvent} that allows full control of
...
public class PaperServerListPingEvent extends ServerListPingEvent implements Cancellable {
	...
	/**
	 * Returns a mutable list of {@link PlayerProfile} that will be displayed as
	 * online players on the client.
	 *
	 * <p>
	 * The Vanilla Minecraft client will display them when hovering the player count
	 * with the mouse.
	 * </p>
	 *
	...
	/**
	 * Returns the protocol version that will be sent as the protocol version of the
	 * server to the client.
	 *
	 * @return The protocol version of the server, or {@code -1} if the server has
	 *         not finished initialization yet
	 */
	...
	/**
	 * Sets the protocol version that will be sent as the protocol version of the
	 * server to the client.
	 *
	 ...
	 *
	 * <p>
	 * <b>Note:</b> For compatibility reasons, this method will return all online
	 * players, not just the ones referenced in {@link #getPlayerSample()}. Removing
	 * a player will:
	 * </p>
	 *
	 * <ul>
