...
public interface PlayerProfile extends org.bukkit.profile.PlayerProfile {
	...
	/**
	 * Gets the {@link PlayerTextures} of this profile. This will build a snapshot
	 * of the current texture data once requested inside PlayerTextures.
	 *
	...
	/**
	 * @return A Mutable set of this players properties, such as textures. Values
	 *         specified here are subject to implementation details.
	 */
	@NotNull
	...
	/**
	 * Sets a property. If the property already exists, the previous one will be
	 * replaced
	 * 
	...
	/**
	 * Sets multiple properties. If any of the set properties already exist, it will
	 * be replaced
	 * 
	...
	/**
	 * Like {@link #complete(boolean)} but will try only from cache, and not make
	 * network calls Does not account for textures.
	 *
	 * @return If the profile is now complete (has UUID and Name)
	 */
	...
	/**
	 * If this profile is not complete, then make the API call to complete it. This
	 * is a blocking operation and should be done asynchronously.
	 *
	 * This will also complete textures. If you do not want to load textures, use
	 * {{@link #complete(boolean)}}
	 * 
	 * @return If the profile is now complete (has UUID and Name) (if you get rate
	 *         limited, this operation may fail)
	 */
	 ...
	 * 
	 * @param textures controls if we should fill the profile with texture
	 *                 properties
	 * @return If the profile is now complete (has UUID and Name) (if you get rate
	 *         limited, this operation may fail)
	 */
