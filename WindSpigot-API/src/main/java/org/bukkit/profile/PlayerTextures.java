...
public interface PlayerTextures {
	 ...
	 * </pre>
	 *
	 * @param skinUrl the URL of the player's skin, or <code>null</code> to unset it
	 */
	 ...
	 * </pre>
	 * <p>
	 * A skin model of <code>null</code> results in {@link SkinModel#CLASSIC} to be
	 * used.
	 *
	 * @param skinUrl   the URL of the player's skin, or <code>null</code> to unset
	 *                  it
	 * @param skinModel the skin model, ignored if the skin URL is <code>null</code>
	 */
	 ...
	 * </pre>
	 *
	 * @param capeUrl the URL of the player's cape, or <code>null</code> to unset it
	 */
