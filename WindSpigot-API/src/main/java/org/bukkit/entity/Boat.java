...
public interface Boat extends Vehicle {
	 ...
	 * Setting this to a higher value allows for quicker acceleration. The default
	 * is 0.2.
	 *
	 ...
	 * The default is -1. Values below 0 indicate that no additional deceleration is
	 * imposed.
	 *
	 * @return The rate of deceleration
	 */
	 ...
	 * Setting this to a higher value allows for quicker deceleration of boats when
	 * a player disembarks. The default is -1. Values below 0 indicate that no
	 * additional deceleration is imposed.
	 *
	 * @param rate deceleration rate
	 */
