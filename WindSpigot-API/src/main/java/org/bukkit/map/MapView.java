...
public interface MapView {
	...
	/**
	 * Get the ID of this map item. Corresponds to the damage value of a map in an
	 * inventory.
	 *
	 ...
	 * internal renderer, but may be used by external renderers. May return null if
	 * the world the map is associated with is not loaded.
	 *
	...
	/**
	 * Set the world that this map is associated with. The world is used by the
	 * internal renderer, and may also be used by external renderers.
	 *
