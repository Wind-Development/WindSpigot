 ...
 * <p>
 * When the server settings dictate 'default' warnings, warnings are printed if
 * the {@link #value()} is true.
 */
...
public @interface Warning {
	...
	public enum WarningState {
		...
		OFF,
		/**
		 * Indicates each warning would default to the configured {@link Warning}
		...
		/**
		 * This method returns the corresponding warning state for the given string
		 * value.
		 *
	...
	/**
	 * This sets if the deprecation warnings when registering events gets printed
	 * when the setting is in the default state.
	 *
