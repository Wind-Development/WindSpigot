...
/**
 * EulerAngle is used to represent 3 angles, one for each axis (x, y, z). The
...
public class EulerAngle {
	...
	/**
	 * Return a EulerAngle which is the result of changing the x axis to the passed
	 * angle
	 *
	...
	/**
	 * Return a EulerAngle which is the result of changing the y axis to the passed
	 * angle
	 *
	...
	/**
	 * Return a EulerAngle which is the result of changing the z axis to the passed
	 * angle
	 *
	...
	/**
	 * Creates a new EulerAngle which is the result of adding the x, y, z components
	 * to this EulerAngle
	 *
	...
	/**
	 * Creates a new EulerAngle which is the result of subtracting the x, y, z
	 * components to this EulerAngle
	 *
