...
public class WorldCreator {
	 ...
	 * will be used.
	 * <p>
	 * If the generator cannot be found for the given name, the natural environment
	 * generator will be used instead and a warning will be printed to the console.
	 *
	 ...
	 * <p>
	 * If the generator cannot be found for the given name, the natural environment
	 * generator will be used instead and a warning will be printed to the specified
	 * output
	 *
	 * @param generator Name of the generator to use, in "plugin:id" notation
	...
	/**
	 * Sets whether or not worlds created or loaded with this creator will have
	 * structures.
	 *
	 ...
	 * <p>
	 * If the world already exists, it will be loaded from disk and some options may
	 * be ignored.
	 *
