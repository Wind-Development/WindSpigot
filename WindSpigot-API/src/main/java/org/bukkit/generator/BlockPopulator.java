...
public abstract class BlockPopulator {
	 ...
	 * there must be one north, east, south and west of the specified chunk. The
	 * "corner" chunks may not exist, in which scenario the populator should record
	 * any changes required for those chunks and perform the changes when they are
	 * ready.
	 *
