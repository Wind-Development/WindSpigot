 ...
 * ValidatingPrompt will keep replaying the prompt text until the user enters a
 * valid response.
 */
public abstract class ValidatingPrompt implements Prompt {
	...
	/**
	 * Accepts and processes input from the user and validates it. If validation
	 * fails, this prompt is returned for re-execution, otherwise the next Prompt in
	 * the prompt graph is returned.
	 *
