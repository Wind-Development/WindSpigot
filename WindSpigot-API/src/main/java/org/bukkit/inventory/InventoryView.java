 ...
 * contracts of certain methods, there's no guarantee that the game will work as
 * it should.
 */
public abstract class InventoryView {
	 ...
	 * <p>
	 * Note: If slot ID -999 is chosen, it may be expected that the item is dropped
	 ...
	 *
	 * @param item The item to put on the cursor, or null to remove the item on
	 *             their cursor.
	 */
	 ...
	 * <p>
	 * If the raw slot refers to the upper inventory, it will be returned unchanged
	 * and thus be suitable for getTopInventory().getItem(); if it refers to the
	...
	/**
	 * Check the total number of slots in this view, combining the upper and lower
	 * inventories.
	 * <p>
	 * Note though that it's possible for this to be greater than the sum of the two
	 * inventories if for example some slots are not being used.
	 *
	 ...
	 * @return true if the property was updated successfully, false if the property
	 *         is not supported by that inventory
	 */
