...
public interface FireworkMeta extends ItemMeta {
	 ...
	 * @throws IllegalArgumentException If any effect is null (may be thrown after
	 ...
	 *
	 * @param effects An iterable object whose iterator yields the desired firework
	 *                effects
	 * @throws IllegalArgumentException If effects is null
	 * @throws IllegalArgumentException If any effect is null (may be thrown after
	 *                                  changes have occurred)
	 ...
	 * @throws IndexOutOfBoundsException If index {@literal < 0 or index >}
	 *                                   {@link #getEffectsSize()}
	 */
	...
	/**
	 * Sets the approximate power of the firework. Each level of power is half a
