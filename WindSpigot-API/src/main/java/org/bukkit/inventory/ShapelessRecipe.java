...
public class ShapelessRecipe implements Recipe {
	 ...
	 * only one instance of it is removed. Only removes exact matches, with a data
	 * value of 0.
	 *
	...
	/**
	 * Removes multiple instances of an ingredient from the list. If there are less
	 * instances then specified, all will be removed. Only removes exact matches,
	...
	/**
	 * Removes multiple instances of an ingredient from the list. If there are less
	 * instances then specified, all will be removed. If the data value is -1, only
	 * ingredients with a -1 data value will be removed.
	 *
	 * @param count      The number of copies to remove.
	 * @param ingredient The ingredient to remove.
	 * @return The changed recipe.
