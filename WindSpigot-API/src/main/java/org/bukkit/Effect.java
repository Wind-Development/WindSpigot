...
public enum Effect {
	...
	/**
	 * The particles generated when a tool breaks. This particle requires a Material
	 * so that the client can select the correct texture.
	 */
	ITEM_BREAK("iconcrack", Type.PARTICLE, Material.class),
	/**
	 * The particles generated while breaking a block. This particle requires a
	 * Material and data value so that the client can select the correct texture.
	 */
	TILE_BREAK("blockcrack", Type.PARTICLE, MaterialData.class),
	/**
	 * The particles generated while sprinting a block This particle requires a
	 * Material and data value so that the client can select the correct texture.
	 */
