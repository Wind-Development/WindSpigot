...
public interface TravelAgent {
	...
	/**
	 * Returns whether the TravelAgent will attempt to create a destination portal
	 * or not.
	 *
	...
	/**
	 * Sets whether the TravelAgent should attempt to create a destination portal or
	 * not.
	 *
	 * @param create Sets whether the TravelAgent should create a destination portal
	 *               or not
	 */
	public void setCanCreatePortal(boolean create);

	/**
	 * Attempt to find a portal near the given location, if a portal is not found it
	 * will attempt to create one.
	 *
	 * @param location the location where the search for a portal should begin
	 * @return the location of a portal which has been found or returns the location
	 *         passed to the method if unsuccessful
	 ...
	 * <p>
	 * In the case of a Nether portal teleportation, this will attempt to create a
	 * Nether portal.
	 * <p>
