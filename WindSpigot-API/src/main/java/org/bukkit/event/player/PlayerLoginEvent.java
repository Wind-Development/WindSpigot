...
public class PlayerLoginEvent extends PlayerEvent {
	...
	public PlayerLoginEvent(final Player player, String hostname, final InetAddress address, final Result result,
			final String message, final InetAddress realAddress) { // Spigot
	...
	/**
	 * Gets the hostname that the player used to connect to the server, or blank if
	 * unknown
	 *
	 * @return The hostname
	 */
	...
	/**
	 * Gets the {@link InetAddress} for the Player associated with this event. This
	 * method is provided as a workaround for player.getAddress() returning null
	 * during PlayerLoginEvent.
	 *
	 * @return The address for this player. For legacy compatibility, this may be
	 *         null.
	 */
