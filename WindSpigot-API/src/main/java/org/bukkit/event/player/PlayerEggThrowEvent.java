...
public class PlayerEggThrowEvent extends PlayerEvent {
	...
	/**
	 * Gets whether the egg is hatching or not. Will be what the server would've
	 ...
	 *
	 * @param hatching true if you want the egg to hatch, false if you want it not
	 *                 to
	 */
	...
	/**
	 * Get the number of mob hatches from the egg. By default the number will be the
	 * number the server would've done
	 * <ul>
	 ...
	 * <p>
	 * The boolean hatching will override this number. Ie. If hatching = false, this
	 * number will not matter
	 *
