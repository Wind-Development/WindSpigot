...
public class PlayerFishEvent extends PlayerEvent implements Cancellable {
	...
	/**
	 * @deprecated replaced by {@link #PlayerFishEvent(Player, Entity, Fish, State)}
	 *             to include the {@link Fish} hook entity.
	 ...
	 * <p>
	 * If player has fished successfully, the result may be cast to
	 ...
	 * <p>
	 * Note: This value has no default effect unless the event state is
	 * {@link State#CAUGHT_FISH}.
	 *
	...
	public enum State {
		...
		IN_GROUND,
		/**
		 * When a player fails to catch anything while fishing usually due to poor
		 * aiming or timing
		 */
		FAILED_ATTEMPT,
	}
