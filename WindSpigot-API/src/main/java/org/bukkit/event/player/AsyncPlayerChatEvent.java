...
public class AsyncPlayerChatEvent extends PlayerEvent implements Cancellable {
	...
	/**
	 * Gets the message that the player is attempting to send. This message will be
	 * used with {@link #getFormat()}.
	 *
	 ...
	 * reduce performance for a lazy set implementation.
	 * <p>
	 * Listeners should be aware that modifying the list may throw
	 * {@link UnsupportedOperationException} if the event caller provides an
	 * unmodifiable set.
	 *
