...
public class BlockIgniteEvent extends BlockEvent implements Cancellable {
	 ...
	 *
	 * @return The Player that placed/ignited the fire block, or null if not ignited
	 *         by a Player.
	 */
	 ...
	 *
	 * @return The Entity that placed/ignited the fire block, or null if not ignited
	 *         by a Entity.
	 */
	 ...
	 *
	 * @return The Block that placed/ignited the fire block, or null if not ignited
	 *         by a Block.
	 */
