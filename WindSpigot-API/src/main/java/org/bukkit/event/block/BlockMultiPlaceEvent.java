 ...
 * {@link #getBlockPlaced()} and its related methods is the block where the
 * placed block would exist if the placement only affected a single block.
 */
public class BlockMultiPlaceEvent extends BlockPlaceEvent {
	 ...
	 * placement of the new blocks. Most of these blocks will just have a Material
	 * type of AIR.
	 *
