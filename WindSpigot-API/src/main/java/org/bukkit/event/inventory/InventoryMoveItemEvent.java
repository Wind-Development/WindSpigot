 ...
 * into the destination inventory. If this is not possible and the ItemStack has
 * not been modified, the source inventory slot will be restored to its former
 * state. Otherwise any additional items will be discarded.
 */
public class InventoryMoveItemEvent extends Event implements Cancellable {
	...
	/**
	 * Gets the ItemStack being moved; if modified, the original item will not be
	 * removed from the source inventory.
	 *
	 * @return ItemStack
	 */
	 ...
	 * ItemStack, the original item will not be removed from the source inventory.
	 *
	...
	/**
	 * Gets the Inventory that initiated the transfer. This will always be either
	 * the destination or source Inventory.
	 *
