...
public enum ClickType {
	 ...
	 * <p>
	 * This is only for transitional purposes on a new Minecraft update, and should
	...
	public boolean isLeftClick() {
		return (this == ClickType.LEFT) || (this == ClickType.SHIFT_LEFT) || (this == ClickType.DOUBLE_CLICK)
				|| (this == ClickType.CREATIVE);
	}

	/**
	 * Gets whether this ClickType indicates that the shift key was pressed down
	 * when the click was made.
	 *
