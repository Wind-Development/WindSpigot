...
public class ServerListPingEvent extends ServerEvent implements Iterable<Player> {
	 ...
	 * {@link #iterator()} method, thus provided the {@link #getNumPlayers()} count.
	 * 
	 ...
	 *                                       created by the caller of this event;
	 *                                       null may be accepted for some
	 *                                       implementations
	 * @throws UnsupportedOperationException if the caller of this event does not
	 *                                       support setting the server icon
	 */
	 ...
	 * player to not be displayed on the player list, decrease the size returned by
	 * {@link #getNumPlayers()}, and will not be returned again by any new iterator.
	 *
	 * @throws UnsupportedOperationException if the caller of this event does not
	 *                                       support removing players
	 */
	@Override
